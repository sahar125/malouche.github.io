...
I’m especially interested in machine learning, statistical modelling  and data visualization.   For my work I use every day `R`, `Python`, `H2O` and `Spark`. I will be sharing  then in this website  many `R` and `Python` codes where I show how you can use these softwares to solve  Machine Learning, Statistical Modelling or Data Visualization problems. Your feedback, comments and questions are then very welcome. 

You will also find in this website  my CV,  links to my papers on several topics, slides of my talks. I will be soon also publishing my `R` packages. 
